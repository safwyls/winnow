...
public sealed class SessionWatcherTests
{
    ...
    /// <see cref="Hoard.Monitor.ProcessListing"/> carries no path. Three hundred
    ...
    /// <summary>
    /// A game that was already running before Hoard started records the truth,
    ...
    /// <summary>
    /// A game installed while Hoard is resident becomes watchable at the next
    ...
    public async Task Shutdown_writes_an_in_flight_session_with_no_end_time()
    {
        ...
        // The game did not stop when Hoard did. "Ended at 20:00" would be a
    ...
    /// before the game — and a whole tree already running when Hoard started —
