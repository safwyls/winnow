...
public sealed class GameDetailsViewModelTests
{
    ...
    public void One_reading_says_it_is_one_reading()
    {
        ...
        Assert.EndsWith("Hoard keeps every reading from here.", details.RecordLine, StringComparison.Ordinal);
    }

    /// <summary>
    /// The delta is between the first and last reading Hoard holds — the part it
