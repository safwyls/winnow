...
public sealed class GameLinkRouterTests
{
    ...
    [InlineData("in-app", true, true, "https://example.com/news", "embedded", false)]
    [InlineData("in-app", true, true, "https://store.steampowered.com/app/440/", "embedded", false)]
    [InlineData("in-app", true, true, "https://www.gog.com/en/game/hades", "embedded", false)]
    [InlineData("in-app", true, true, "https://store.epicgames.com/en-US/p/hades", "embedded", false)]
    [InlineData("in-app", true, true, "https://www.steamgriddb.com/grid/1", "embedded", false)]
    [InlineData("in-app", true, true, "http://example.com/article", "embedded", false)]
    [InlineData("store", true, true, "https://example.com/article", "https", true)]
    [InlineData("store", true, true, "https://www.steamgriddb.com/grid/1", "https", true)]
    [InlineData("store", true, true, "http://example.com/article", "http", true)]
    [InlineData("in-app", true, true, "steam://run/440", "steam", false)]
    [InlineData("in-app", true, true, "goggalaxy://openGameView/gog_1", "goggalaxy", false)]
