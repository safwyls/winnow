...
public sealed class LaunchAttributionTests
{
    ...
    /// <summary>
    /// The same situation with nobody having clicked Play in Winnow: still
    ...
    public async Task A_pending_launch_never_relabels_a_process_the_filesystem_can_place()
    {
        ...
        // Inferred, not launched: Winnow did not start this one, and saying it
    ...
    /// a game Winnow launched that hands off to a second executable is still a
    ...
    /// watched at all when the user starts it from Winnow.
    /// </summary>
    [Fact]
