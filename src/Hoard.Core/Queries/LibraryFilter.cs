...
public sealed record LibraryFilter
{
    ...
    ///
    /// <para>Hoard's own surrogate ids (migration 0007), not IGDB's — the cached
    ...
    /// answer — a vocabulary Hoard owns.</para>
    /// </summary>
...
[JsonSourceGenerationOptions(
    // Matches the snake_case the rest of Hoard's stored and wire JSON uses, and
