...
/// it does mean a blob written by Hoard cannot be decrypted by another
...
public sealed class DpapiEpicSecretProtector : IEpicSecretProtector
{
    ...
    /// </summary>
    private static readonly byte[] Entropy = Encoding.UTF8.GetBytes("Hoard.Epic.OAuth.v1");
...
/// again after a restart. Hoard's Epic ingest is Windows-shaped anyway — the
