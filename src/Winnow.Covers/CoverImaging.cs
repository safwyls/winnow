...
public static class CoverImaging
{
    ...
    /// five buckets are the grid's. 1280 serves the desktop screenshot lightbox;
    /// larger buckets serve full-canvas landscapes at HD, ultrawide and 4K sizes.</para>
    /// <para>Decoding never upscales past the source, so a 1200x1800 Steam
    /// capsule asked for at 1280 still decodes at 1200.</para>
    /// </summary>
    public static readonly int[] WidthBuckets = [160, 240, 320, 480, 640, 1280, 1920, 2560, 3840];
