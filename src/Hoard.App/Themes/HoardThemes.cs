...
///     <description>Hoard and Nightshift are cool, Tungsten is genuinely warm,
...
///     <description>How much colour the chrome is allowed at all. Hoard's
...
///     <description>Where the contrast lives. Hoard steps evenly; Nightshift is
...
public static class HoardThemes
{
    ...
    /// "Hoard with the lights off", it was a value change and nothing else, and
    ...
    /// the rail, the brightest edge in the set and nearly twice Hoard's. The
    ...
    /// black rather than Hoard's green-teal, so the two are not siblings at any
    ...
    public static readonly HoardTheme Nightshift = new()
    {
        ...
        VoltPress = C("#14C2E2"),
        Amber = C("#FFC24A"),
        // Pale periwinkle, 35° off Volt — the same separation Hoard puts between
    ...
    /// </summary>
    public static readonly HoardTheme Tungsten = new()
    {
        Id = "tungsten",
        Name = "Tungsten",
    ...
    /// 4.8x above it — against Hoard's 1.8x and Nightshift's 1.4x. So the covers
    ...
    /// </summary>
    public static readonly HoardTheme BoxArt = new()
    {
        Id = "box-art",
        Name = "Box art",
    ...
    public static readonly IReadOnlyList<HoardTheme> All = [Hoard, Nightshift, Tungsten, BoxArt];
