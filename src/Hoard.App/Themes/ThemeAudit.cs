...
public static class ThemeAudit
{
    ...
    /// </summary>
    public static IReadOnlyList<ThemeDiagnostic> Inspect(HoardTheme theme, string fileName)
    {
    ...
    /// is.</para>
    /// </summary>
    public static ThemeReport Report(HoardTheme theme)
    {
        var t = theme.Tokens(transparency: 0);
        return new ThemeReport(
            ...
            // what §14.1.1's value-structure column is: "Hoard 1.8x art→chrome,
