...
/// referencing a type out of <c>Hoard.Ingest.Epic</c> — the boundary deleted by
...
public enum StoreSignInProblem
{
    ...
    /// <summary>Epic answered with something Hoard could not read.</summary>
    Unexpected,
}

/// <summary>
/// What Hoard remembers about a storefront account, with no network call made
/// to find out.
///
