...
-- session Hoard launched is still discovered by the poll and still ended by the
...
-- Play inside Hoard, none of that arises — the app already knows which ownership
-- was asked for.
--
-- ── Values ───────────────────────────────────────────────────────────────────
--
--   'launch'    Hoard fired the store URI for this ownership and a process
...
--               whether a human clicked Play in Hoard or in Steam, so back-filling
...
-- ours and closed: it is written by exactly one line of code in Hoard.Monitor. A
