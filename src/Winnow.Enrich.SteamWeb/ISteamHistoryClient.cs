...
{
    /// <summary>
    /// Whether either Steam credential is live: a Web API key or a sign-in
    /// session whose access token has not expired. False is the ordinary
    /// state for an unconfigured install, not an error.
    /// </summary>
