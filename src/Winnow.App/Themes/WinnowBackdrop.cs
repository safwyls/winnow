...
/// </summary>
public static class WinnowBackdrops
{
    /// <summary>
    ...
    /// </summary>
    public const WinnowBackdrop Default = WinnowBackdrop.Acrylic;

    /// <summary>In the order the screen draws them: the default first.</summary>
    public static readonly IReadOnlyList<WinnowBackdrop> All =
        [WinnowBackdrop.Acrylic, WinnowBackdrop.Mica];

    public static string Id(WinnowBackdrop backdrop) => backdrop switch
    {
        WinnowBackdrop.Mica => "mica",
        WinnowBackdrop.Acrylic => "acrylic",
        _ => "none",
    };

    public static string Name(WinnowBackdrop backdrop) => backdrop switch
    {
        WinnowBackdrop.Mica => "Mica",
        WinnowBackdrop.Acrylic => "Acrylic",
        _ => "None",
    ...
    /// error, for the same reason <c>WinnowThemes.ById</c> does it: a preference
    ...
    /// </summary>
    public static WinnowBackdrop ById(string? id) => id switch
    {
        "mica" => WinnowBackdrop.Mica,
        "acrylic" => WinnowBackdrop.Acrylic,
        _ => Default,
    };
}
