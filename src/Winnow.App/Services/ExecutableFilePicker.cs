...
/// <summary>
/// Opens the OS file dialog and returns the local path of a chosen executable,
...
/// <summary>
/// <see cref="IExecutableFilePicker"/> that opens Avalonia's
/// <see cref="IStorageProvider"/> file dialog on the main window.
/// </summary>
public sealed class TopLevelExecutableFilePicker : IExecutableFilePicker
{
    /// <inheritdoc/>
