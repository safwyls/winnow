...
/// <c>Winnow.Recommend.DataTier</c> would be naming a scoring type in the
...
/// see <see cref="Winnow.App.ViewModels.IGameTileSource"/>.
/// </param>
...
///
/// <para><b>Why this is not <c>Winnow.Core.Domain.FeedVerdictKinds</c>.</b> Same
...
/// behavioural — a Winnow-launched session on a game the feed had just shown —
