...
public partial class AppearanceViewModel : ObservableObject
{
    ...
    /// produces new <see cref="WinnowTheme"/> instances — a card holding the
    ...
    public string TransparencyStatus => TransparencyUnavailable
        ? "This machine is not compositing the desktop behind the window, so Winnow is drawing solid. The setting stays where you left it and takes effect where it can."
        : WallTranslucent
...
/// a <see cref="Winnow.App.Themes.WinnowBackdrop"/> for the material, a
