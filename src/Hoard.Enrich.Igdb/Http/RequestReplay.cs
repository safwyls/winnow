...
/// consumed (and often disposed) by the first attempt. Buffering the Apicalypse
/// body once and rebuilding a fresh message per attempt is the only correct
/// option, and it is cheap here because the bodies are a few hundred bytes of
/// text/plain.</para>
/// </summary>
