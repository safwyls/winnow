...
public sealed record MatchSubject
{
    ...
    /// fetched/hashed yet. Winnow.Resolve never computes this — see
...
///
/// <para><b>Not implemented here, by design.</b> Winnow.Resolve owns matching,
/// not imaging: decoding cover art, computing a dHash/pHash and caching it
/// belongs to the cover pipeline (<c>src/Winnow.Covers</c>). This interface
