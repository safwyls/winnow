...
/// <summary>A launch Hoard started that the watcher has now seen running.</summary>
...
/// <summary>
/// <b>The M3b attribution seam: what Hoard knows when Hoard did the launching.</b>
///
...
///
/// <para><b>None of that arises when the user clicked Play inside Hoard.</b> The
...
public sealed class LaunchIntents
{
    ...
    /// <summary>
    /// Records that Hoard is about to fire the store's launch URI for this
