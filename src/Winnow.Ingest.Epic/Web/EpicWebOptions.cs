...
public sealed class EpicWebOptions
{
    ...
    /// to the user; never fetched by Winnow.
    ///
    ...
    /// blast radius is smaller than it appears. A user who finds Winnow's Epic
    ...
    /// send a descriptive Winnow user agent so Valve can attribute — and if
    ...
    /// a launcher string. Winnow sends a launcher string with its own name
