...
///
/// <para><b>What is at stake is smaller than it looks.</b> Winnow's staleness
...
/// unit affects the number Winnow displays, not which bucket a game lands in.</para>
/// </summary>
...
///
/// <para><b>This is not the same as "Winnow cannot name an API-only title".</b>
    ...
    long? TotalPlaytime)
{
    ...
    /// or through Winnow's own process monitor, accumulates nothing Epic-side.
