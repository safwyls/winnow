...
/// <summary>
/// Epic's launcher OAuth client, embedded in Winnow. The LAST source consulted,
...
/// Winnow has no right to enters the repository or a shipped binary", and "the
...
/// on the launcher client. So the choice was never "Winnow's credentials or the
...
/// this pair. Winnow is now the party distributing it, not the user, which is a
...
public sealed class BuiltInEpicCredentialSource : IEpicCredentialSource
{
    ...
    /// make the next person reading this file believe Winnow is protecting
